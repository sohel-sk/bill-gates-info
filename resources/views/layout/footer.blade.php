<footer class="bg-black py-6 px-8 font-[sans-serif]">
    <div class="flex flex-col lg:flex-row items-center justify-between">
      <ul class="flex space-x-4 max-lg:mb-6">
        <li>
          <a href="https://www.facebook.com/BillGates/">
            <svg fill="none" class="fill-gray-300 inline hover:fill-white w-6 h-6"
              viewBox="0 0 24 24">
      ...
      <p class='text-sm max-lg:mb-6 text-gray-300'>Copyright © 2023<a href='/' target='_blank'
          class="hover:underline mx-1">Bill-gates.info</a>All Rights Reserved.</p>
